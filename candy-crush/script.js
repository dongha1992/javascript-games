document.addEventListener("DOMContentLoaded", () => {
    ...
    squares.forEach(square => square.addEventListener("drop", drapDrop))

    function dragStart() {
        colorBeingDragged = this.style.backgroundImage
        squareIdBeingDargged = parseInt(this.id)
    ...
    function checkRowForFour() {
        for (let i = 0; i < 60; i++) {
            ...
            const notValid = [5, 6, 7, 13, 14, 15, 21, 22, 23, 30, 31, 37, 38, 39, 45, 46, 47, 53, 54, 55]
